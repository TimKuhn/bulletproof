<template>
  <div id="app">
    <div id="nav" class="fixed bottom-0 flex justify-around antialiased w-full text-gray-600 bg-gray-900 uppercase border-t border-blue-600">
      ...
      <router-link to="/fooddetail" :class="{ 'text-blue-600': '/fooddetail' == this.$route.fullPath }">
        <div class="px-4 pt-2 text-center">
          <font-awesome-icon icon="clock" class="text-2xl"/>
